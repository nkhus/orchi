...
The 24 scenarios in `scenarios.json` define live evaluation cases. They are not executed by pytest and must not be counted as passed deterministic tests.
