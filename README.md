...
- **Every title shows its lineage.** Issues are titled `[INITIATIVE][PAY] Card payments`, `[EPIC][PAY-1] Tokenize stored cards`, `[TASK][PAY-1.2] Add token column`; branches reuse the key (`epic/pay-1-tokenize-cards`).
